...
class HoldingsViewPostTests(TestCase, PortfolioTestMixin):
    ...
    def test_add_holding_success(self) -> None:
    ...
    def test_add_holding_existing_warning(self) -> None:
    ...
    def test_add_holding_invalid_form(self) -> None:
        url = reverse("portfolio:account_holdings", args=[self.account.id])
    ...
    def test_bulk_update_shares(self) -> None:
